...
module.exports = {
  execute: async (client, message, prefix, db) => {
    ...
    if (data.banned == true && message.author.id !== "693661618021859329" && message.author.id !== "693661618021859329") return message.channel.send(`${message.author.username} you're banned from this bot.`)
